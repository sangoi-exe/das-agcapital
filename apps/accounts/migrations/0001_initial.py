    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpf', models.CharField(max_length=11, unique=True, validators=[django.core.validators.RegexValidator('^\\d{11}$', 'CPF deve conter 11 dígitos, apenas números.')], verbose_name='CPF')),
                ('phone_number', models.CharField(blank=True, max_length=11, null=True, validators=[django.core.validators.RegexValidator('^\\d{11}$', 'O número de telefone deve seguir o formato XX9XXXXXXX.')], verbose_name='Número de Celular')),
